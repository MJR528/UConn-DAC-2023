...
class TensorDataset:
    ...
    def __getitem__(self, index):
        ...
        # debug
        # for box in label:
        #     bx, by, bw, bh = bsox[2], box[3], box[4], box[5]
...
if __name__ == "__main__":
    data = TensorDataset("/home/cc/Dev/IdeaProjects/UConn/Ding/dac2023-gpu/data/training/train.txt", 1280,720)
    ...
    # dataset = ImportVOC(
    #     "./data/train/Annotations", path_to_images="../JPEGImages"
    # )
    # print(dataset.analyze.classes)
    # a = ""
    # for c in dataset.analyze.classes:
    #     a+=c
    #     a+="\n"
    # from pathlib import Path
    # Path("./data/")
    # dataset.splitter.GroupShuffleSplit(train_pct=0.7, test_pct=0.3, val_pct=0)
    # dataset.export.ExportToYoloV5("./data/training", use_splits=True, copy_images=True)
    

    # print(dataset.df['img_filename'][0])