#From https://github.com/Azure/azureml-examples/blob/main/sdk/python/jobs/automl-standalone-jobs/automl-image-object-detection-task-fridge-items/yolo_onnx_preprocessing_utils.py
import cv2
import numpy as np
import torch
import time
